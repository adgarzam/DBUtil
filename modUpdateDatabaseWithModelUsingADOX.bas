Attribute VB_Name = "modUpdateDatabaseWithModelUsingADOX"
' #VBIDEUtils#************************************************************
' * Author           : Larry Rebich
   ...
   For Each oTableSource In oCatalogSource.Tables
      With oTableSource
         If .Type = "TABLE" Then
            ...
            Call AddFields(oTableSource, oTableDest, tUpdateDatabaseWithModelUsingADOX) 'add fields if necessary
         End If
      End With
   Next
...
Private Function AddFields(oTableSource As ADOX.Table, oTableDest As ADOX.Table, tUpdateDatabaseWithModelUsingADOX As udtUpdateDatabaseWithModelUsingADOX) As Boolean
   ' #VBIDEUtils#************************************************************
   ' * Author           : Larry Rebich
   ' * Web Site         : http://www.vbdiamond.com
   ' * E-Mail           : larry@buygold.net
...
Private Sub LogOpenAndClear(connDB As ADODB.Connection, connModel As ADODB.Connection, tUpdateDatabaseWithModelUsingADOX As udtUpdateDatabaseWithModelUsingADOX)
   ...
   If Not mbSkipWriteToLog Then
      ...
      If gsFileNameLog = "" Then
         msFileNameLog = AddBackslash(msAppPath) & mcsLog
      Else
...
Private Sub LogErrorOpenAndClear(t As udtUpdateDatabaseWithModelUsingADOX)
   ...
   If gsFileNameErrorLog = "" Then
      msFileNameErrorLog = AddBackslash(msAppPath) & mcsErrorLog
   Else
